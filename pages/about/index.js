...
const About = () => {
  ...
  <div className="h-full bg-primary/30 py-32 text-center xl:text-left">
    ...
    gap-x-6'>
      ...
      exit="hidden" 
      className="h2">
        Captivating <span className="text-accent">stories</span> birth magnificent desings
      </motion.h2>
      <motion.p 
    ...
    >
        10 years ago, I began feelancing as a developer. Since then, I ve 
        done remote work for agencies, counsulted for startups, and 
        collabotated on digital products for business and consumer use.
      </motion.p>
      {/* counters */}
      ...
      animate="show"
      exit="hidden" 
      className="hidden md:flex md:max-w-xl xl:max-w-done mx-auto xl:mx-0 mb-8"
    >
    ...
    >
        ...
        items-center xl:items-start">
          {aboutData[index].info.map((item, itemIndex)=> {
            return (
            <div key={itemIndex} className="flex1 flex flex-col md:flex-row
